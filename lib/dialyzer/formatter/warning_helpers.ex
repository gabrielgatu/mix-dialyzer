defmodule Dialyzer.WarningHelpers do
  ...
  def call_or_apply_to_string(
    ...
    pretty_signature_args = Dialyzer.PrettyPrint.pretty_print_args(signature_args)
  ...
  def call_or_apply_to_string(
    ...
    pretty_print_signature =
      Dialyzer.PrettyPrint.pretty_print_contract("#{signature_args} -> #{signature_return}")
